//! Integration tests for raw multi-document updates through collection access.
//!
//! The tests cover successful matching updates, malformed update documents,
//! and assigning a valid value to an optional email field.
